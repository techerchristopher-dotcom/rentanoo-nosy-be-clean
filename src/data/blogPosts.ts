...
Si votre priorité est d'être autonome dès le premier jour, prenez quelques minutes pour réserver proprement avant le départ. À Nosy Be, ce petit effort en amont change souvent le rythme du séjour dès les [premières heures](https://rentanoo.com/blog/aeroport-fascene-guide-arrivee).`,
  },
  {
    ...
    category: "Guide pratique",
    readTime: 6,
    excerpt: "Le scooter est le meilleur moyen de découvrir Nosy Be à votre rythme. Routes, plages, villages : notre guide complet pour explorer l'île en deux-roues.",
    seoTitle: "Visiter Nosy Be en scooter — Guide complet 2026 | Rentanoo",
    seoDescription: "Notre guide pour visiter Nosy Be en scooter : meilleurs itinéraires, routes praticables, plages accessibles, conseils de sécurité et tarifs de location.",
    content: `## Pourquoi le scooter est idéal à Nosy Be

Nosy Be est une île de 320 km² : les distances sont courtes et les routes relativement simples. Le scooter vous permet de vous arrêter où vous voulez, d'éviter les taxis-brousses bondés et de découvrir des coins que les touristes en voiture ratent souvent.

## Les routes principales à explorer

**Route du nord (Ambatoloaka → Andilana)** : La route côtière vers Andilana est l'une des plus belles de l'île. Comptez 45 minutes en scooter depuis Ambatoloaka. Vous traverserez Madirokely, Ambanoro et arriverez à la plage d'Andilana, considérée comme la plus belle de Nosy Be.

**Route vers Dzamandzar** : Au nord-est de l'île, cette route traverse des paysages verdoyants et des villages typiques. La plage de Dzamandzar est moins fréquentée et offre un cadre authentique.

**Route des collines (Hell-Ville → Mont Passot)** : Le Mont Passot (329 m) est le point culminant de Nosy Be. La route est goudronnée jusqu'au sommet. Vue panoramique sur les lacs volcaniques et la côte.

## Conseils pratiques

- **Essence** : Faites le plein à Hell-Ville. Les stations sont rares ailleurs sur l'île. Prévoyez une petite réserve.
- **Heure de départ** : Partez tôt le matin (7h-8h) pour éviter la chaleur et profiter des routes moins fréquentées.
- **Pluie** : En saison des pluies (décembre-mars), certaines pistes peuvent être impraticables. Vérifiez la météo avant de partir vers les zones isolées.
- **Casque** : Portez votre casque en permanence. Il est obligatoire et fourni avec votre scooter Rentanoo.
- **Carburant** : Un plein suffit généralement pour un tour complet de l'île (environ 60 km).

## Plages accessibles en scooter

1. **Ambatoloaka** : La plage principale, animée, idéale pour s'acclimater
2. **Madirokely** : Plage plus calme, à 3 km d'Ambatoloaka
3. **Andilana** : La plus belle plage de l'île, eaux turquoise
4. **Dzamandzar** : Plage authentique, peu de touristes
5. **Palm Beach** : Coucher de soleil exceptionnel

## Budget scooter pour un séjour à Nosy Be

Comptez entre 25 € et 50 € par jour selon le modèle. Pour 7 jours, des réductions sont disponibles sur Rentanoo. Idéalement, louez dès votre arrivée à l'aéroport Fascène pour ne pas perdre de temps.`,
  },
  {
    slug: "itineraire-nosy-be-4-jours",
    title: "Itinéraire Nosy Be 4 jours : que voir et que faire",
    date: "2026-05-15",
    category: "Itinéraires",
    readTime: 8,
    excerpt: "4 jours à Nosy Be : notre programme jour par jour pour ne rien rater. Plages, villages, restaurants, activités nautiques et excursions incontournables.",
    seoTitle: "Itinéraire Nosy Be 4 jours – Programme complet 2026 | Rentanoo",
    seoDescription: "Programme jour par jour pour visiter Nosy Be en 4 jours : plages, Mont Passot, Nosy Tanikely, villages malgaches. Conseils pratiques et budget.",
    content: `## Jour 1 — Arrivée et Ambatoloaka

**Matin** : Atterrissage à l'aéroport international Fascène. Récupérez votre scooter Rentanoo directement à l'aéroport. Installation à votre hébergement à Ambatoloaka.

**Après-midi** : Découverte du quartier d'Ambatoloaka : plage principale, marché artisanal, restaurants en bord de mer. Premiers bains dans l'océan Indien.

**Soir** : Dîner à Ambatoloaka. Les restaurants de poissons frais et fruits de mer sont excellents et accessibles (moins de 15 €/personne).

## Jour 2 — Tour du nord de l'île

**Matin** : Départ en scooter vers le nord. Route côtière jusqu'à Madirokely (10 min), puis Ambanoro, puis la plage d'Andilana (45 min depuis Ambatoloaka). Baignade dans les eaux turquoise.

**Après-midi** : Détour par Dzamandzar pour la plage sauvage. Retour par l'intérieur des terres via les plantations d'ylang-ylang.

**Soir** : Coucher de soleil depuis la plage de Palm Beach (côté ouest).

## Jour 3 — Excursion île Nosy Tanikely

**Journée entière** : Excursion en bateau vers l'île de Nosy Tanikely, réserve marine nationale. Snorkeling exceptionnel, tortues marines, poissons tropicaux. Excursion organisable depuis Ambatoloaka (35-50 €/personne).

## Jour 4 — Mont Passot et Hell-Ville

**Matin** : Montée au Mont Passot (329 m) en scooter. Vue panoramique sur les 7 lacs volcaniques et la côte. Pique-nique au sommet.

**Après-midi** : Visite de Hell-Ville, la capitale de Nosy Be. Marché couvert, épices, artisanat local. Architecture coloniale française.

**Soir** : Dernier dîner à Ambatoloaka. Retour scooter à l'aéroport le lendemain matin si départ prévu.

## Budget estimé pour 4 jours à Nosy Be

| Poste | Estimation |
|-------|-----------|
| Hébergement (4 nuits) | 120-300 € |
| Location scooter (4j) | 100-180 € |
| Repas (4j, 3 repas/jour) | 100-150 € |
| Excursion Nosy Tanikely | 35-50 € |
| Divers (entrées, achats) | 30-50 € |
| **Total estimé** | **385-730 €** |

## Conseils pratiques

- Réservez votre scooter et hébergement avant d'arriver, surtout en juillet-août
- L'ariary (MGA) est la monnaie locale. Les euros sont acceptés dans les hôtels et restaurants touristiques
- Prévoyez de la crème solaire indice 50+ minimum`,
  },
  {
    slug: "aeroport-fascene-guide-arrivee",
    title: "Aéroport Fascène Nosy Be : guide complet pour votre arrivée",
    date: "2026-04-20",
    category: "Conseils voyage",
    readTime: 5,
    excerpt: "Tout ce qu'il faut savoir sur l'aéroport international de Nosy Be (NOS) : arrivée, douane, change, transport et livraison de votre scooter ou voiture.",
    seoTitle: "Aéroport Fascène Nosy Be (NOS) — Guide arrivée 2026 | Rentanoo",
    seoDescription: "Guide complet arrivée à l'aéroport Fascène de Nosy Be : formalités, douane, change, transports depuis l'aéroport. Livraison scooter et voiture disponible.",
    content: `## L'aéroport international de Nosy Be (Fascène)

L'aéroport international de Nosy Be, officiellement nommé aéroport de Fascène (code IATA : NOS), est situé à environ 12 km d'Ambatoloaka. Il est géré par Ravinala Airports depuis 2018 et a été entièrement rénové.

## Vols desservant Nosy Be

Les principales compagnies opérant sur Fascène depuis la France :
- **Air Austral** (La Réunion, avec correspondance)
- **Air Madagascar** (depuis Antananarivo)
- **Corsair** (vols saisonniers depuis Paris)

Des charters saisonniers opèrent également depuis plusieurs villes françaises en haute saison (juillet-octobre).

## Arrivée et formalités

**Visa** : Les ressortissants français bénéficient d'un visa à l'arrivée gratuit pour 30 jours, renouvelable. Passeport valide 6 mois après la date d'entrée requis.

**Douane** : Les formalités sont rapides. Déclaration de devises obligatoire au-delà de 7 500 €.

**Santé** : Carte de vaccination contre la fièvre jaune obligatoire si vous venez d'un pays endémique. Prophylaxie antipaludéenne recommandée.

## Change à l'aéroport

Des bureaux de change sont disponibles dans le hall d'arrivée. Le taux est légèrement moins favorable qu'en ville. L'euro est la devise la plus acceptée à Nosy Be.

## Transport depuis l'aéroport

**Taxi** : Des taxis sont disponibles à la sortie. Comptez 15 000-25 000 Ar (environ 6-10 €) jusqu'à Ambatoloaka. Négociez avant de monter.

**Transfert hôtel** : La plupart des hôtels proposent un transfert payant. Réservez à l'avance.

**Livraison Rentanoo** : Rentanoo livre votre scooter, moto ou voiture directement à l'aéroport Fascène. Précisez votre numéro de vol lors de la réservation. C'est le moyen le plus pratique pour démarrer votre séjour immédiatement.

## Conseils pratiques à l'arrivée

- Récupérez des ariary (MGA) au bureau de change de l'aéroport pour les petites dépenses
- Achetez une carte SIM locale (Telma ou Airtel) dans le hall d'arrivée
- La connexion internet de l'aéroport est limitée — téléchargez vos cartes hors ligne avant de partir
- Protégez-vous du soleil dès la sortie de l'avion`,
  },
];
